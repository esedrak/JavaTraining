...
/**
 * An abstract Vehicle demonstrating the Template Method pattern with
 * a concrete method that cannot be overridden and an abstract hook.
 */
public abstract class Vehicle {
    ...
    /**
     * Template method — defines the start sequence.
     * Subclasses customise via startEngine(), not start() itself.
     */
    public void start() {
        checkFuel();
        startEngine();
