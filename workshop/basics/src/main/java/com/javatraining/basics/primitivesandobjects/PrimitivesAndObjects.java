...
public class PrimitivesAndObjects {
    ...
    /**
     * Demonstrates the Integer cache trap.
     * Integers in the range -128..127 are cached by the JVM.
    ...
    /**
     * Primitives are passed by value: changes inside this method do NOT
    ...
    /**
     * Object references are also passed by value. Reassigning the reference
     * inside this method does NOT affect the caller's reference.
     */
     ...
     * because both caller and callee reference the same object.
     */
    ...
    /**
     * String + creates a new String object every time.
     * For concatenation in loops, use StringBuilder.
     */
