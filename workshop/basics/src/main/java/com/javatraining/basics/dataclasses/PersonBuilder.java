...
/**
 * PersonBuilder demonstrates the manual Builder pattern for a class
 * with many fields, which is the idiomatic Java alternative to
 * named or default constructor parameters.
 */
