 ...
 * - Wildcard lower bound: <? super T>  (for write)
 * - Wildcard upper bound: <? extends T> (for read)
 *
...
public class BoundedGenerics {
    ...
    /**
     * Returns the sum of a list of Numbers as a double.
     * T must extend Number, giving us access to doubleValue().
     */
