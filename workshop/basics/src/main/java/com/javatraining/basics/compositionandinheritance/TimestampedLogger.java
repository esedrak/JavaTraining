 ...
 *
 * <p>This is the Decorator pattern via composition: TimestampedLogger HAS-A Logger (delegate), not
 * IS-A ConsoleLogger. This means any Logger implementation can be decorated, not just
 * ConsoleLogger.
 */
