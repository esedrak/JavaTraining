 ...
 * Topic 4: Null Safety
 *
 * Demonstrates idiomatic Java approaches to handling null:
 * - Optional<T> for values that may be absent
 * - Objects.requireNonNull for guard clauses
 * - Objects.isNull / Objects.nonNull for explicit null checks
 */
public class NullSafety {
    ...
    /**
     * Returns Optional.empty() if userId is null,
     * otherwise simulates a lookup and returns an email.
     */
