 ...
 *
 * At compile time, generics provide type safety.
 * At runtime, generic type information is erased and replaced with
 * the upper bound (usually Object).
 *
 * This means:
 * - ArrayList<String> and ArrayList<Integer> are the same class at runtime
 * - You cannot use instanceof with parameterized types (use List<?>)
 * - You CAN recover generic type info from fields via reflection (not variables)
 */
    ...
    public static void showErasure() {
        ...
        try {
            ...
            if (genericType instanceof ParameterizedType pt) {
                ...
                System.out.println("Recovered generic type argument of stringList: " + typeArg.getTypeName());
