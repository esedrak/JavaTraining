 ...
 * Topic 11: Generics
 *
 * GenericBox<T> is a simple container demonstrating:
 * - Generic type parameter
 * - Bounded type methods
 * - map() for transforming the contained value
 * - Static factory methods with type inference
 */
public class GenericBox<T> {
    ...
    /**
     * Transforms the value inside the box using the given mapper function.
     * Returns a new GenericBox<U> without modifying the original.
     */
